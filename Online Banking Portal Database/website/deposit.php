...
<html lang="en" dir="ltr">
  ...
  <div class="nav-wrapper">
    ...
    <h3>Deposit Screen</h3>
    <h3>Select an Account to Deposit to:</h3>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        $("#table_main tbody tr").click(function () {
          ...
          var td=tableData[1];
          var value = prompt("How much would you like to deposit? : ", 100,"prompt", "$");
          console.log("Amount to be added:", value);
          ...
          var ask = window.confirm(`Please insert ${value} money.`);

          if (ask) {
              window.alert("Transaction Complete.");

              window.location.href = "depositConfirmed.php?value="+value+"&account_number="+account_number+"&client_card_number="+client_card_number;
